                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            while ($row = mysqli_fetch_array($res)) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit_customer.php?id=<?php echo $row["id"]; ?>" style="color:green">Edit</a></td>
                                    <td><a href="delete_customer.php?id=<?php echo $row["id"]; ?>" style="color:red">Delete</a></td>
                                </tr>
                                <?php
                            }
                            ?>
...
if (isset($_POST["submit1"])) {
    ...
    mysqli_query($link, "insert into Customer_info values(NULL,'$_POST[firstname]','$_POST[lastname]','$_POST[businessname]','$_POST[contact]','$_POST[address]','$_POST[city]')") or die(mysqli_error($link));
    ?>
    <script type="text/javascript">
