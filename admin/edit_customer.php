...
$res=mysqli_query($link,"select * from customer_info where id=$id");
...
if (isset($_POST["submit1"])) {
    ...
    mysqli_query($link, "update customer_info set firstname='$_POST[firstname]',lastname='$_POST[lastname]',businessname='$_POST[businessname]',contact='$_POST[contact]',address='$_POST[address]',city='$_POST[city]' where id=$id") or die(mysqli_error($link));
    ?>
    <script type="text/javascript">
